...
\end{Sinput}
\end{Schunk}
\includegraphics{ECTheory-complexity_in_simulation}
...
\end{Sinput}
\end{Schunk}
\includegraphics{ECTheory-complexity_between_simulation}
...
The fast approximation implemented in
\texttt{ECTermScoring} is the same used in \texttt{ECProb} for between connectedeness, but applied to edge counts between elements and terms.
